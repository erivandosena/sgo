...
uses UnCaixa, UnCaixaVenda;

{$R *.dfm}

procedure TFrmRelCarne.CriaCodigo(Cod: String; Imagem: TCanvas);
...
CriaCodigo(FrmCaixaVenda.IBQuery_ImprimeCarne.FieldByName('NUMERO_DOC').AsString, Grafico.Canvas);
end;
