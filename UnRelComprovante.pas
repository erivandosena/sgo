...
if FrmCaixa.IBQuery_VETIPO_VENDA.AsString = 'Á VISTA' then
begin
...
QRLabel_Prestacoes.Caption:= 'Prestações: '+IntToStr(Fracao)+' X R$ '+FloatToStrF(VDParcela,ffFixed,18,2);
...
QRLabel_Medico.Caption:= 'Médico: '+FrmCaixa.IBQuery_VENOME_MEDICO.AsString;
