object FrmReimpComp: TFrmReimpComp
  Left = 482
  Top = 256
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'Reimpress'#227'o de Comprovante'
  ClientHeight = 414
  ClientWidth = 537
  Color = clBtnFace
  ...
  object IBQuery_Itens: TIBQuery
    ...
    SQL.Strings = (
        ...
        ', TELEFONE, COD_PROD, DESCRICAO, NUMERO_CONTRATO, QUANTIDADE, VA' +
        'LOR_TOTAL, VALOR_UNITARIO from EMPRESA,ITEM ')
    Left = 176
    Top = 320
    object IBQuery_ItensBAIRRO: TIBStringField
      FieldName = 'BAIRRO'
      Origin = '"EMPRESA"."BAIRRO"'
      Size = 30
    end
    object IBQuery_ItensCEP: TIBStringField
      FieldName = 'CEP'
      Origin = '"EMPRESA"."CEP"'
      Size = 10
    end
    object IBQuery_ItensCIDADE: TIBStringField
      FieldName = 'CIDADE'
      Origin = '"EMPRESA"."CIDADE"'
      Size = 25
    end
    object IBQuery_ItensCNPJ: TIBStringField
      FieldName = 'CNPJ'
      Origin = '"EMPRESA"."CNPJ"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    ...
    object IBQuery_ItensEMAIL: TIBStringField
      FieldName = 'EMAIL'
      Origin = '"EMPRESA"."EMAIL"'
      Size = 50
    end
    object IBQuery_ItensENDERECO: TIBStringField
      FieldName = 'ENDERECO'
      Origin = '"EMPRESA"."ENDERECO"'
      Size = 50
    end
    object IBQuery_ItensESTADO_UF: TIBStringField
      FieldName = 'ESTADO_UF'
      Origin = '"EMPRESA"."ESTADO_UF"'
      Size = 25
    end
    object IBQuery_ItensIE: TIBStringField
      FieldName = 'IE'
      Origin = '"EMPRESA"."IE"'
      Size = 11
    end
    object IBQuery_ItensTELEFONE: TIBStringField
      FieldName = 'TELEFONE'
