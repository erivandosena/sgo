...
uses UnDm, UnPrincipal, UnLocalizar, UnRelCarne, UnRelRecibo,
  ...
  UnProdutos, UnCaixaEntrada, UnCaixaSaidaB, UnCaixaOutrasEntradasB;

{$R *.dfm}

procedure TFrmCaixaB.FormShow(Sender: TObject);
begin
FrmCaixaB.Top:=0;
FrmCaixaB.Left:=0;
...
begin
FrmCaixaB.Caption:= FrmCaixaB.Caption;
Exit;
end else
FrmCaixaB.Caption:= FrmCaixaB.Caption+' - '+Dm.IBDS_EMPRESANOME_FANTASIA.AsString;
end;

procedure TFrmCaixaB.SbNovoClick(Sender: TObject);
begin
IBQueryVenda.Close;
...
Panel_CaixaLivre1.Visible:= False;
SbNovo.Caption:= '&Executando '+Opcao;
FrmCaixaSaidaB:= TFrmCaixaSaidaB.Create(Application);
try
  FrmCaixaSaidaB.ShowModal;
finally
  FrmCaixaSaidaB.Free;
end;
Exit;
...
procedure TFrmCaixaB.SbSalvarClick(Sender: TObject);
begin
...
procedure TFrmCaixaB.DBGrid1KeyPress(Sender: TObject; var Key: Char);
Var
...
procedure TFrmCaixaB.ComboBoxTipoKeyPress(Sender: TObject; var Key: Char);
var
...
procedure TFrmCaixaB.CBox_QuantidadeKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TFrmCaixaB.ComboBoxTipoExit(Sender: TObject);
var
Forma : array[0..4] of String [20] ;
F : integer;
begin
...
procedure TFrmCaixaB.ComboBoxTipoChange(Sender: TObject);
begin
ComboBoxTipo.Text:= 'Á VISTA';
end;

procedure TFrmCaixaB.BtnCIClick(Sender: TObject);
Var
...
procedure TFrmCaixaB.ComboBoxFormaKeyPress(Sender: TObject; var Key: Char);
begin
if Key = #13 then
  begin
  Key := #0;{ Suprime o som }
...
procedure TFrmCaixaB.FormCreate(Sender: TObject);
begin
Shortdateformat:='dd/mm/yyyy';
end;

procedure TFrmCaixaB.DBGrid2KeyPress(Sender: TObject; var Key: Char);
begin
if Key = #13 then
  begin
  Key := #0;{ Suprime o som }
...
procedure TFrmCaixaB.FormDestroy(Sender: TObject);
begin
Dm.IBDS_VENDAS.Close;
end;

procedure TFrmCaixaB.DBGrid1DrawColumnCell(Sender: TObject;
...
procedure TFrmCaixaB.Localizar1Click(Sender: TObject);
begin
...
procedure TFrmCaixaB.ComboBoxGrupoKeyPress(Sender: TObject; var Key: Char);
Var
...
procedure TFrmCaixaB.ComboBox4Change(Sender: TObject);
begin
...
procedure TFrmCaixaB.ComboBox4KeyPress(Sender: TObject; var Key: Char);
begin
if Key = #13 then
  begin
  Key := #0;{ Suprime o som }
...
procedure TFrmCaixaB.Edit1KeyPress(Sender: TObject; var Key: Char);
begin
if Key = #13 then
  begin
  Key := #0;{ Suprime o som }
...
procedure TFrmCaixaB.Edit1Change(Sender: TObject);
begin
  IBQuery_Produtos.Close;
  IBQuery_Produtos.Open;
if ComboBox4.Text = 'Por Descrição' then
...
procedure TFrmCaixaB.SbFechaClick(Sender: TObject);
begin
...
procedure TFrmCaixaB.DBGrid2DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
begin
...
procedure TFrmCaixaB.ComboBoxNPKeyPress(Sender: TObject; var Key: Char);
begin
If not( key in['0'..'9',',',#8,#13] ) then
begin
Abort;
...
procedure TFrmCaixaB.ComboBoxOpcaoKeyPress(Sender: TObject; var Key: Char);
begin
if Key = #13 then
  begin
  Key := #0;{ Suprime o som }
...
FrmCaixaOutrasEntradasB:= TFrmCaixaOutrasEntradasB.Create(Application);
try
  FrmCaixaOutrasEntradasB.ShowModal;
finally
  FrmCaixaOutrasEntradasB.Free;
end;
Exit;
end else
Opcao:= ComboBoxOpcao.Text;
...
procedure TFrmCaixaB.ComboBoxOpcaoChange(Sender: TObject);
begin
ComboBoxOpcao.Text:= 'VENDA';
end;

procedure TFrmCaixaB.ComboBoxOpcaoVendaChange(Sender: TObject);
begin
Panel_Fracao.Visible:= False;
...
procedure TFrmCaixaB.ComboBoxOpcaoVendaKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure TFrmCaixaB.ComboBoxFormaChange(Sender: TObject);
begin
ComboBoxForma.Text:= 'CHEQUE';
end;

procedure TFrmCaixaB.FormCloseQuery(Sender: TObject; var CanClose: Boolean);
begin
if iOK <> 625 then Canclose := False;
iOK:= 624;
end;

procedure TFrmCaixaB.DBGrid_ParcelasMouseMove(Sender: TObject; Shift: TShiftState;
  X, Y: Integer);
begin
Abort;
end;

procedure TFrmCaixaB.WMMove(var Msg: TWMMove);
begin
...
function TFrmCaixaB.DifDateUtil(dataini, datafin: string): integer;
var a,b,c:tdatetime;
  ct,s:integer;
begin
...
function TFrmCaixaB.ObterNumeros(var Numero_Documento,
...
function TFrmCaixaB.ObterNumero(var Numero_Documento: string): boolean;
var
  Form: TForm; { Variável para o Form }
  Medt1: TMaskEdit; { Variável para o MaskEdit }
begin
...
procedure TFrmCaixaB.ComboBoxNPExit(Sender: TObject);
begin
if ComboBoxNP.Text = '' then
begin
ComboBoxNP.Text:= '1';
...
procedure TFrmCaixaB.DBCBox_VendedorKeyPress(Sender: TObject;
  var Key: Char);
begin
if Key = #13 then
  begin
...
function TFrmCaixaB.ObterDataPagamento(var Data_Pago: string): boolean;
var
  Form: TForm; { Variável para o Form }
  Medt1: TMaskEdit; { Variável para o MaskEdit }
begin
...
procedure TFrmCaixaB.MaskEdit_VIKeyPress(Sender: TObject; var Key: Char);
begin
If not( key in['0'..'9',',',#8,#13] ) then
begin
Abort;
...
procedure TFrmCaixaB.ComboBoxGrupoExit(Sender: TObject);
begin
...
procedure TFrmCaixaB.DBEdit1Exit(Sender: TObject);
begin
...
procedure TFrmCaixaB.CBox_ConfirmaKeyPress(Sender: TObject; var Key: Char);
begin
if Key = #13 then
  begin
  Key := #0;{ Suprime o som }
...
procedure TFrmCaixaB.CBox_ConfirmaChange(Sender: TObject);
begin
CBox_Confirma.Text:= 'ENCERRAR';
end;

function TFrmCaixaB.ObterLente(var Codigo, Descricao: string): boolean;
var
  Form: TForm; { Variável para o Form }
  Medt1: TMaskEdit; { Variável para o MaskEdit }
  Medt2: TMaskEdit;
...
procedure TFrmCaixaB.ME_ClienteKeyPress(Sender: TObject; var Key: Char);
begin
if Key = #13 then
  begin
  Key := #0;{ Suprime o som }
...
procedure TFrmCaixaB.MaskEdit_VencimentoKeyPress(Sender: TObject;
  var Key: Char);
begin
If not( key in['0'..'9',#8,#13] ) then
begin
...
procedure TFrmCaixaB.tbSetCapsLock(State: boolean);
begin
...
procedure TFrmCaixaB.IBQuery_EstornoEAfterDelete(DataSet: TDataSet);
begin
if EstornoEnt = '' then
begin
...
procedure TFrmCaixaB.IBQuery_EstornoSAfterDelete(DataSet: TDataSet);
begin
if EstornoSai = '' then
begin
ShowMessage('Selecione o lançamento e pressione "Enter" antes de executar.');
...
procedure TFrmCaixaB.ComboBoxNPChange(Sender: TObject);
begin
Panel_Fracao.Visible:= False;
...
procedure TFrmCaixaB.DBEdit1KeyPress(Sender: TObject; var Key: Char);
begin
If not( key in['0'..'9',#8,#13] ) then
begin
Abort;
...
procedure TFrmCaixaB.MaskEdit_VencimentoExit(Sender: TObject);
begin
ShowMessage ('Data inválida.');
Exit;
end;

procedure TFrmCaixaB.DBGrid1CellClick(Column: TColumn);
begin
if DBGrid1.Fields[0].Text = '' then
begin
MaskEdit_VI.Enabled:= False;
