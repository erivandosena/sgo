...
procedure TFrmReimpComp.FormShow(Sender: TObject);
begin
...
procedure TFrmReimpComp.CBox_ClienteKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TFrmReimpComp.BtnFecharClick(Sender: TObject);
begin
Close;
end;

procedure TFrmReimpComp.CBox_ContratoKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure TFrmReimpComp.Btn_ImprimirClick(Sender: TObject);
begin
...
procedure TFrmReimpComp.DBGrid_ContratosKeyPress(Sender: TObject;
  var Key: Char);
begin
if Key = #13 then
  begin
...
procedure TFrmReimpComp.FormCreate(Sender: TObject);
begin
Shortdateformat:='dd/mm/yyyy';
end;

procedure TFrmReimpComp.CBox_FaturaKeyPress(Sender: TObject;
  var Key: Char);
begin
if Key = #13 then
  begin
...
procedure TFrmReimpComp.DBGrid1KeyPress(Sender: TObject; var Key: Char);
begin
if Key = #13 then
  begin
  Key := #0;{ Suprime o som }
...
procedure TFrmReimpComp.DBGrid2KeyPress(Sender: TObject; var Key: Char);
begin
if Key = #13 then
  begin
  Key := #0;{ Suprime o som }
